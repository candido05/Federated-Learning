...
Este projeto faz parte de um TCC (Trabalho de Conclusão de Curso) acadêmico.

## Contato

Para questões ou problemas, consulte a documentação da tese ou entre em contato com o mantenedor do projeto.
